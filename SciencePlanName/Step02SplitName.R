# R 中文分詞(科技部專案計畫)
# 設定工作路徑為專案目錄
setwd("E:/LBH/Dropbox/GitHub/SciencePlanName/")
...
# 載入要分割的檔案
textSource <- read.csv("totalName.csv",stringsAsFactor=F)
...
textResultDF <- data.frame(NAME=textSource[,1],ORGANZIATION=textResultDF[,1],DEPARTMENT=textResultDF[,2],DUTY=textSource[,3],TEL=textSource[,4])
